...
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3, ImgURL)
VALUE (1,1,'Quel poste tient Harry Potter dans son équipe de quidditch ?',
       'Harry Potter','Attrapeur','Batteur','Poursuiveur','Lanceur','Harry potter1');
#--Harry Poter : questions 2--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,1,'Dans quelle école de sorcellerie Harry Potter a-t-il suivi ses enseignements ?',
       'Harry Potter','Poudlard','Oxford','Cambridge','West Point','Harry potter1');
#--Harry Poter : questions 3--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,1,'À quelle adresse habite la famille Dursley dans la saga « Harry Potter » ?',
       'Harry Potter', '4 Privet Road','4 Privet Avenue','4 Privet Square',' 4 Privet Drive','Harry potter1');
#--Harry Poter : questions 4--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,1,'Qui a succédé à Armando Dippet comme directeur de Poudlard dans « Harry Potter » ?',
       'Harry Potter', 'Albus Dumbledore', 'Ron Weasley', 'Severus Rogue', 'Lord Voldemort','Harry potter1');

--Level 2--

#--Harry Poter : questions 5--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,2,'Comment se prénomment les parents du jeune Harry Potter ?',
       'Harry Potter', 'James et Lily', 'Olivia et Tom', 'Hermione et Ron', 'Laurena et Victor','Harry potter2');
#--Harry Poter : questions 6--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,2,'Quelle est la marque du balai de course utilisé par Harry Potter ?',
       'Harry Potter', 'Nimbus 2000', 'Brossdur 5', 'Comète 260', 'Étoile Filante','Harry potter2');
#--Harry Poter : questions 7--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,2,'Quel est le nom du dragon appartenant à Hagrid dans la saga « Harry Potter » ?',
       'Harry Potter', 'Norbert', 'Errol', 'Crockdur', 'Aragog','Harry potter2');

--Level 3--

#--Harry Poter : questions 8--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,3,'Quelle est la formule du sortilège de mort dans la saga « Harry Potter » ?',
       'Harry Potter', 'Avada Kedavra ', 'Mortibus Rem', 'Machina Fino', 'Post Mortem ','Harry potter3');
#--Harry Poter : questions 9--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,3,'Quels prénoms portent les jumeaux Weasley dans « Harry Potter » ?',
       'Harry Potter', 'Fred et George', 'Bill et George', 'Charlie et Bill', 'Lou et Cédric','Harry potter3');
#--Harry Poter : questions 10--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (1,3,'Dans la saga « Harry Potter », qui est le prince de sang mêlé ?',
       'Harry Potter', 'Severus Rogue', 'Dumbledore', 'Voldemort', 'Drago Malefoy','Harry potter3');
...
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
    VALUE (2,2,'Quel célèbre détective se cache souvent sous une apparence malhabile ?',
           'Dessin Animée','Columbo', 'Bayard', 'Japp', 'Duflair','Dessin Animee2');
#--Dessin Animée : questions 2--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
    VALUE (2,2,'Qui est le créateur de la série « Les Simpson » ?',
           'Dessin Animée','Matt Groening','Homer Simpson','Dan Castellaneta','Donald Trump','Dessin Animee2');
#--Dessin Animée : questions 7--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
    VALUE (2,2,"Quel commissaire de fiction, héros de romans policiers, fume souvent la pipe ?",
           'Dessin Animée','Maigret', 'Hercule Poirot', 'Simon Templar', 'Sam Spade','Dessin Animee2');
...
VALUE (5,2,'Quel personnage de « Star Wars » a été conçu comme un alien ressemblant à une limace ?',
       'Héros de Star Wars','Jabba le Hutt', 'Dark Maul', 'Mace Windu', 'Lando Calrissian','Star Wars2');
...
VALUE (5,2,'Qui a enregistré un message dans les circuits intégrés de R2-D2 dans « Un Nouvel Espoir » ?',
       'Héros de Star Wars','La Princesse Leia', 'Anakin', 'Chewbacca', 'Obi-Wan','Star Wars2');
...
VALUE (5,2,'Quelle est la couleur du sabre laser de Mace Windu, créateur de la technique du Vaapad ?',
       'Héros de Star Wars', 'Violette', 'Rouge', 'Verte', 'Bleue','Star Wars2');
...
VALUE (5,3,'Après avoir imposé le respect auprès des maîtres Jedi, à quel âge Yoda est-il mort ?',
       'Héros de Star Wars','900 ans', '2 200 ans', '1 200 ans', '750 ans','Star Wars3');
...
VALUE (5,3,'Apparu dans les épisodes II et III, comment le comte Dooku est-il également appelé ?',
       'Héros de Star Wars','Dark Tyranus', 'Dark Sidious', 'Dark Malak', 'Dark Vador','Star Wars3');
#--Héros de Star Wars : questions 10--
INSERT INTO question (id_quiz, level, text, themes, goodAnswer, badAnswer, badAnswer2, badAnswer3,ImgURL)
VALUE (5,3,'Quel autre nom est utilisé pour désigner Leia Amidala Skywalker, soeur de Luke ?',
       'Héros de Star Wars', 'Leia Organa', 'Leia Amidala', 'Leia Windu', 'Leia Solo','Star Wars3');
